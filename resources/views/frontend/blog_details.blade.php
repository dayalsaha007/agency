                    ...
                    <div class="col-lg-8">
                        <div class="standard__blog__post">
                            <div class="standard__blog__thumb">
                                <img src="{{ asset('uploads/blog') }}/{{ $blog_detail->blog_image }}" alt="">
                            </div>
                            <div class="blog__details__content services__details__content">
                                <ul class="blog__post__meta">
                                    <li><i class="fal fa-calendar-alt"></i>
                                    {{ Carbon\Carbon::parse($blog_detail->created_at)->diffforHumans() }}
                                    </li>
                            ...
                            <div class="blog__details__bottom">
                                <ul class="blog__details__tag">
                                    ...
                                    <li class="tags-list">
                                        <a href="#">{{ $blog_detail->blog_tags }}</a>
                                    </li>
                                </ul>
                                    ...
                                    @foreach ($blogs as $blog)
                                        <li class="rc__post__item">
                                            <div class="rc__post__thumb">
                                                <a href="{{ route('blog_detail', $blog->id) }}"><img src="{{ asset('uploads/blog') }}/{{ $blog->blog_image }}"
                                                        alt=""></a>
                                            </div>
                            ...
                            <div class="widget">
                                ...
                                <ul class="sidebar__cat">
                                    @foreach ($blog_cat as $cat)
                                        <li class="sidebar__cat__item"><a href="{{ route('blog_cat_detail', $cat->id) }}">{{ $cat->blog_category_name }}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                            <div class="widget">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="homeContact__content">
                                ...
                                <h2 class="mail"><a
                                        href="/cdn-cgi/l/email-protection#733a1d151c330416111e121a1f5d101c1e"><span
                                            class="__cf_email__"
                                            data-cfemail="9ad3f4fcf5daedfff8f7fbf3f6b4f9f5f7">[email&#160;protected]</span></a>
                                </h2>
                            </div>
                        </div>
                        <div class="col-lg-6">
