            ...
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-8 col-md-10">
                    <div class="breadcrumb__wrap__content">
                        <h2 class="title">{{ $port->portfolio_name }}</h2>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="services__details__thumb">
                        <img src="{{ asset('uploads/portfolio') }}/{{ $port->portfolio_image }}" alt="">
                    </div>
                    <div class="services__details__content">
                        <h2 class="title">{{ $port->portfolio_title }}</h2>
                    ...
                    <aside class="services__sidebar">
                        ...
                        <div class="widget">
                            ...
                            <ul class="sidebar__contact__info">
                                ...
                                <li><span>Mail :</span> <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="f28b9d87809f939b9eb2959f939b9edc919d9f">[email&#160;protected]</a></li>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="homeContact__content">
                            ...
                            <h2 class="mail"><a href="/cdn-cgi/l/email-protection#2d64434b426d5a484f404c4441034e4240"><span class="__cf_email__" data-cfemail="4d04232b220d3a282f202c2421632e2220">[email&#160;protected]</span></a></h2>
                        </div>
                    </div>
                    <div class="col-lg-6">
