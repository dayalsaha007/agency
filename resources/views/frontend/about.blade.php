    ...
    <main>
        ...
        <section class="breadcrumb__wrap">
            ...
            <div class="breadcrumb__wrap__icon">
                <ul>
                    <li><img src="{{ asset('frontend_asset') }}/assets/img/icons/breadcrumb_icon01.png" alt=""></li>
                    <li><img src="{{ asset('frontend_asset') }}/assets/img/icons/breadcrumb_icon02.png" alt=""></li>
                    <li><img src="{{ asset('frontend_asset') }}/assets/img/icons/breadcrumb_icon03.png" alt=""></li>
                    <li><img src="{{ asset('frontend_asset') }}/assets/img/icons/breadcrumb_icon04.png" alt=""></li>
                    <li><img src="{{ asset('frontend_asset') }}/assets/img/icons/breadcrumb_icon05.png" alt=""></li>
                    <li><img src="{{ asset('frontend_asset') }}/assets/img/icons/breadcrumb_icon06.png" alt=""></li>
                </ul>
            </div>
        </section>
        <!-- breadcrumb-area-end -->
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="about__image">
                            <img src="{{ asset('uploads/about_image') }}/{{ $about->about_image }}" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="about__content">
                            ...
                            <div class="about__exp">
                                <div class="about__exp__icon">
                                    <img src="{{ asset('frontent_asset') }}/assets/img/icons/about_icon.png" alt="">
                                </div>
                                    ...
                                    <div class="about__award__wrap">
                                        <div class="row justify-content-center">
                                            <div class="col-md-6 col-sm-9">
                                                <div class="about__award__item">
                                                    <div class="award__logo">
                                                        <img src="{{ asset('uploads/frontend_asset') }}/img/images/awards_01.png" alt="">
                                                    </div>
                                            ...
                                            <div class="col-md-6 col-sm-9">
                                                <div class="about__award__item">
                                                    <div class="award__logo">
                                                        <img src="{{ asset('uploads/frontend_asset') }}/img/images/awards_02.png" alt="">
                                                    </div>
                                                    <div class="award__content">
                                            ...
                                            <div class="col-md-6 col-sm-9">
                                                <div class="about__award__item">
                                                    <div class="award__logo">
                                                        <img src="{{ asset('uploads/frontend_asset') }}/img/images/awards_03.png" alt="">
                                                    </div>
                                                    <div class="award__content">
                                            ...
                                            <div class="col-md-6 col-sm-9">
                                                <div class="about__award__item">
                                                    <div class="award__logo">
                                                        <img src="{{ asset('uploads/frontend_asset') }}/img/images/awards_04.png" alt="">
                                                    </div>
                                                    <div class="award__content">
                ...
                <div class="services__style__two__wrap">
                    <div class="row gx-0">
                        <div class="col-xl-3 col-lg-4 col-md-6">
                            <div class="services__style__two__item">
                                <div class="services__style__two__icon">
                                    <img src="{{ asset('uploads/frontend_asset') }}/img/icons/services_light_icon01.png" alt="">
                                </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6">
                            <div class="services__style__two__item">
                                <div class="services__style__two__icon">
                                    <img src="{{ asset('uploads/frontend_asset') }}/img/icons/services_light_icon02.png" alt="">
                                </div>
                                <div class="services__style__two__content">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6">
                            <div class="services__style__two__item">
                                <div class="services__style__two__icon">
                                    <img src="{{ asset('uploads/frontend_asset') }}/img/icons/services_light_icon03.png" alt="">
                                </div>
                                <div class="services__style__two__content">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6">
                            <div class="services__style__two__item">
                                <div class="services__style__two__icon">
                                    <img src="{{ asset('uploads/frontend_asset') }}/img/icons/services_light_icon05.png" alt="">
                                </div>
                                <div class="services__style__two__content">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6">
                            <div class="services__style__two__item">
                                <div class="services__style__two__icon">
                                    <img src="{{ asset('uploads/frontend_asset') }}/img/icons/services_light_icon06.png" alt="">
                                </div>
                                <div class="services__style__two__content">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6">
                            <div class="services__style__two__item">
                                <div class="services__style__two__icon">
                                    <img src="{{ asset('uploads/frontend_asset') }}/img/icons/services_light_icon04.png" alt="">
                                </div>
                                <div class="services__style__two__content">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6">
                            <div class="services__style__two__item">
                                <div class="services__style__two__icon">
                                    <img src="{{ asset('uploads/frontend_asset') }}/img/icons/services_light_icon07.png" alt="">
                                </div>
                                <div class="services__style__two__content">
                                    <h3 class="title"><a href="services-details.html">Visual Design</a></h3>
                                    <p>Strategy is a forward-looking plan for your brand’s behavior.Strategy is a
        ...
        <section class="testimonial testimonial__style__two">
                                    ...
                                    <div class="testimonial__content">
                                        ...
                                        <div class="testimonial__avatar">
                                            ...
                                            <div class="testi__avatar__img">
                                                <img src="{{ asset('uploads/frontend_asset') }}/img/images/testi_avatar01.png" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="testimonial__item">
                                    ...
                                    <div class="testimonial__content">
                                        ...
                                        <div class="testimonial__avatar">
                                            ...
                                            <div class="testi__avatar__img">
                                                <img src="{{ asset('uploads/frontend_asset') }}/img/images/testi_avatar02.png" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="testimonial__two__icons">
                <ul>
                    <li><img src="{{ asset('uploads/frontend_asset') }}/img/icons/testi_shape01.png" alt=""></li>
                    <li><img src="{{ asset('uploads/frontend_asset') }}/img/icons/testi_shape02.png" alt=""></li>
                    <li><img src="{{ asset('uploads/frontend_asset') }}/img/icons/testi_shape03.png" alt=""></li>
                    <li><img src="{{ asset('uploads/frontend_asset') }}/img/icons/testi_shape04.png" alt=""></li>
                    <li><img src="{{ asset('uploads/frontend_asset') }}/img/icons/testi_shape05.png" alt=""></li>
                    <li><img src="{{ asset('uploads/frontend_asset') }}/img/icons/testi_shape06.png" alt=""></li>
                </ul>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row gx-0 justify-content-center">
                    <div class="col-lg-4 col-md-6 col-sm-9">
                        <div class="blog__post__item">
                            <div class="blog__post__thumb">
                                <a href="blog-details.html"><img src="{{ asset('uploads/frontend_asset') }}/img/blog/blog_post_thumb01.jpg"
                                        alt=""></a>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-9">
                        <div class="blog__post__item">
                            <div class="blog__post__thumb">
                                <a href="blog-details.html"><img src="{{ asset('uploads/frontend_asset') }}/img/blog/blog_post_thumb02.jpg"
                                        alt=""></a>
                                <div class="blog__post__tags">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-9">
                        <div class="blog__post__item">
                            <div class="blog__post__thumb">
                                <a href="blog-details.html"><img src="{{ asset('frontend_asset') }}/img/blog/blog_post_thumb03.jpg"
                                        alt=""></a>
                                <div class="blog__post__tags">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="homeContact__content">
                                ...
                                <h2 class="mail"><a
                                        href="/cdn-cgi/l/email-protection#b2fbdcd4ddf2c5d7d0dfd3dbde9cd1dddf"><span
                                            class="__cf_email__"
                                            data-cfemail="eea7808881ae998b8c838f8782c08d8183">[email&#160;protected]</span></a>
                                </h2>
                            </div>
                        </div>
                        <div class="col-lg-6">
